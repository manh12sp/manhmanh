...
while wait(.1) do
    ...
    local listfastattack = {"Low Attack", "Normal Attack", "Windy Super Attack"}
	...
	elseif _G.FastAttackFaiFao_Mode == "Low Attack" then
		_G.Fast_Delay = 0.10
	elseif _G.FastAttackFaiFao_Mode == "Windy Super Attack" then
		_G.Fast_Delay = 0.01
	end
end)
...
spawn(
    function()
        while wait(0.4) do
            pcall(
                function()
                    if _G.FastAttackWindy then
                        repeat
                            wait(_G.Fast_Delay)
                            AttackNoCD()
                        until not _G.FastAttackWindy
                    end
                end
            )
        end
